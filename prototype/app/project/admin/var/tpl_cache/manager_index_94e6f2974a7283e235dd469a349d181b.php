...
<a  href="javascript:;" onclick="promptDelete('<?php echo $row['id']; ?>','<?php echo $row['name']; ?>')">删除</a>|
<?php endif; ?>

<a href="javascript:;" onclick="pwdReset('<?php echo $row['id']; ?>','<?php echo $row['name']; ?>');">重置密码</a>
</td>
</tr>
<?php } } ?>
</table>
