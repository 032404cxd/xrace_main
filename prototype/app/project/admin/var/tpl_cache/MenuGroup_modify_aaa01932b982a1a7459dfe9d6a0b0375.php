...
<form name="group_update_form" id="group_update_form" action="<?php echo $this->sign; ?>&ac=update" method="post">
...
<INPUT TYPE="hidden" NAME="group_id" id="group_id" value="<?php echo $group['group_id']; ?>">
	<tr>
		...
		<?php echo $group['group_id']; ?></td>
	</tr>
	<tr>
		<th class="rowtip"><label for="name">组名</label></th><td class="rowform">
		<input type="text" name="name" id="name" class="span4" value="<?php echo $group['name']; ?>"/>
