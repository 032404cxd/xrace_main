...
<form id="list_form" name="list_form" action="?ctl=menu&ac=sort" method="post" style="width:100%;margin:0 auto;">
    <table border="0" cellpadding="0" cellspacing="0" class="table table-striped">
        ...
        <tr class="hover" id="<?php echo $menu['menu_id']; ?>" level="1" ondblclick="getChildMenu(this.id,2)" style="cursor: pointer;">
            ...
            <td width="400"><?php echo $menu['permission_list']; ?></td>
            <td width="200"><a href="javascript:;" onclick="divBox.showBox('?ctl=menu&ac=modify&menu_id=<?php echo $menu['menu_id']; ?>', {title:'修改菜单',height:550,width:620});">修改</a>
            ...
            <?php if($menu['Child']!=1) { ?>| <a href="?ctl=menu/permission&ac=modify.by.menu&menu_id=<?php echo $menu['menu_id']; ?>">权限</a><?php } ?>
            </td>
        </tr>
        <?php } } ?>
