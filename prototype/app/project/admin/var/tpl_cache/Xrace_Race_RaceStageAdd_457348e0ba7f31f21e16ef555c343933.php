...
<form id="race_stage_add_form" name="race_stage_add_form"" action="<?php echo $this->sign; ?>&ac=race.stage.insert" metdod="post">
...
<tr class="hover"><td>所属赛事</td>
	<td align="left">	<select name="RaceCatalogId" id="RaceCatalogId" size="1" onchange="getGroupList()">
			...
			<option value="<?php echo $oRaceCatalog['RaceCatalogId']; ?>" ><?php echo $oRaceCatalog['RaceCatalogName']; ?></option>
			<?php } } ?>
		</select></td>
</tr>
	<td>赛事分组列表</td>
