<?php include Base_Common::tpl('header'); ?>
</style>
    			...
    			<div class="container-fluid">
    				...
    				<ul class="nav" id="mobile-nav">
                        <?php if (is_array($menuArr)) { foreach ($menuArr as $menu) { ?>
                            <?php if (is_array($allowedMenuArr)) { foreach ($allowedMenuArr as $purview) { ?>
                                <?php if($menu['menu_id'] == $purview['menu_id']) { ?> 
            						<li class="dropdown">
            							<a id="_block_<?php echo $menu['menu_id']; ?>" href="javascript:getMenu('<?php echo $menu['menu_id']; ?>');"><i class="icon-list-alt icon-white"></i> <?php echo $menu['name']; ?> </a>
            						</li>
                                <?php } ?>   
                            <?php } } ?>	
                        <?php } } ?>						
...
<?php include Base_Common::tpl('footer'); ?>