...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="style/RightStyle.css"  />
        ...
        .br_bottom{padding-bottom:20px;}
        .br_top{padding-top:20px;}
        .br_left{padding-left:20px;}    
        .br_right{padding-right:20px;} 
        </style>
...
<script type="text/javascript">
if(!frameElement.api){
    document.write('<div id="loading_layer" style="display:none"><img src="img/ajax_loader.gif" alt="" /></div>');
}
</script>