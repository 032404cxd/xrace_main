<?php
class Cli_ReadMoneyLogController extends Base_Controller_Action{	
            ...
            {                              
                ...
                switch ($log['function'])
                {
                    ...
                    case "moneylog":
                        ...
                        'MoneyLogTime'=>strtotime($log['time']),
                        'AppId'=>$ServerData['AppId'],
                        'PartnerId'=>$ServerData['PartnerId'],
                        'ServerId'=>$ServerData['ServerId'],
                        'MoneyType'=>$log['data']['MoneyType'],
                        'MoneyChanged'=>$log['data']['MoneyChanged'],
                        'MoneyTotal'=>$log['data']['MoneyTotal'],
                        'Reason'=>$log['data']['Reason'],
                        'Attach'=>$log['data']['Attach'],
                        );
                                            
                        $oMoneyLog = new Lm_Money();
                        $insertLog = $oMoneyLog->insertMoneyLog($DataArr);
                        break;
                }
