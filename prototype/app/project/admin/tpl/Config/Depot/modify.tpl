...
<td>机房ID</td>
<td>{tpl:$Depot.DepotId/} </td>
</tr>

		<input type="hidden" name="DepotId" id="DepotId" class="span3" value="{tpl:$Depot.DepotId/}"/>
<tr>
<td>名称</td>
<td><input type="text" name="name" id="name" class="span3"  value="{tpl:$Depot.name/}" onblur='CheckDepotName()'/> * </td>
</tr>
<tr>

<tr>
		<td>机房排数编号</td>
		<td><input type="text" name="X" id="X" class="span3" value="{tpl:$Depot.X/}"/> * 请以英文,分割 </td>
</tr>
<tr>
<td>备注</td>
<td><input type="text" name="Comment" id="Comment" class="span4"  value="{tpl:$Depot.Comment/}"/> * </td>
</tr>
