...
<form id="money_add_form" name="money_add_form" action="{tpl:$this.sign/}&ac=insert" metdod="post">
		<table widtd="99%" align="center" class="table table-bordered table-striped" widtd="99%">

		<tr class="hover">
			<td>游戏内货币类型ID</td>
			<td align="left"><input name="MoneyId" type="text" class="span4" id="MoneyId" value="" size="50" /></td>
		</tr>
		...
		<td><button type="submit" id="money_add_submit">提交</button></td>
		</tr>
	</table>
	</form>
...
$('#money_add_submit').click(function(){
	var options = {
		dataType:'json',
	...
	$('#money_add_form').ajaxForm(options);
});
