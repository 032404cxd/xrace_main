...
<form id="instmap_add_form" name="instmap_add_form" action="{tpl:$this.sign/}&ac=insert" metdod="post">

		<table widtd="99%" align="center" class="table table-bordered table-striped" widtd="99%">

		<tr class="hover">
			<td>副本ID</td>
			<td align="left"><input name="InstMapId" type="text" class="span4" id="InstMapId" value="" size="50" /></td>
		</tr>
		...
		<td><button type="submit" id="instmap_add_submit">提交</button></td>
		</tr>
	</table>
	</form>
...
$('#instmap_add_submit').click(function(){
	var options = {
		dataType:'json',
	...
	$('#instmap_add_form').ajaxForm(options);
});
</script>
