...
<script type="text/javascript">
  ...
  function RaceUserList(rid,rname){
    RaceUserListBox = divBox.showBox('{tpl:$this.sign/}&ac=race.user.list&RaceId=' + rid, {title:rname+'选手名单',width:400,height:750});
  }
</script>
...
<table width="99%" align="center" class="table table-bordered table-striped">
  ...
  {/tpl:loop}
  <tr>
    <th align="center" class="rowtip" colspan="11">  <a href="javascript:;" onclick="RaceAdd('{tpl:$RaceStageInfo.RaceStageId/}','{tpl:$RaceGroupInfo.RaceGroupId/}')">点此添加</a>
    </th>
  </tr>
  {tpl:else}
  <tr>
