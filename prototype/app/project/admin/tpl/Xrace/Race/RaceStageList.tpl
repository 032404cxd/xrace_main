...
<table width="99%" align="center" class="table table-bordered table-striped">
  ...
  <tr>
    ...
    <th align="center" class="rowtip" ><a href="{tpl:$this.sign/}&ac=user.check.in.status&RaceStageId={tpl:$RaceStageInfo.RaceStageId/}">签到</a> | <a  href="javascript:;" onclick="RaceStageDelete('{tpl:$RaceStageInfo.RaceStageId/}','{tpl:$RaceStageInfo.RaceStageName/}');">删除</a> |  <a href="javascript:;" onclick="RaceStageModify('{tpl:$RaceStageInfo.RaceStageId/}');">修改</a> | <a href="javascript:;" onclick="ProductModify('{tpl:$RaceStageInfo.RaceStageId/}');">产品</a> |  <a href="{tpl:$this.sign/}&ac=race.combination.list&RaceStageId={tpl:$RaceStageInfo.RaceStageId/}">套餐组合</a></th></tr>
