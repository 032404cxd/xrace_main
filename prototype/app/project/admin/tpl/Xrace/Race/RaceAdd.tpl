...
<tr class="hover"><th align="center" class="rowtip">男性成员数量</th><th align="center" class="rowtip">最少:<input name="SexUser[Min][1]" type="text" class="span1" id="SexUser[Min][1]" value = "1" size="50" />最高:<input name="SexUser[Max][1]" type="text" class="span1" id="SexUser[Max][1]" value = "0" size="50" /></th></tr>
<tr class="hover"><th align="center" class="rowtip">女性成员数量</th><th align="center" class="rowtip">最少:<input name="SexUser[Min][2]" type="text" class="span1" id="SexUser[Min][2]" value = "1" size="50" />最高:<input name="SexUser[Max][2]" type="text" class="span1" id="SexUser[Max][2]" value = "0" size="50" /></th></tr>
