...
<form id="dnf_form" name="dnf_form" action="{tpl:$this.sign/}&ac=user.race.dnf" method="post">
...
<tr class="noborder">
<td colspan = 2 align=""><button type="submit" id="dnf_submit" name="dnf_submit">提交</button></td>
</tr>
</table>
</form>

<script type="text/javascript">
$('#dnf_submit').click(function(){
	var options = {
		dataType:'json',
