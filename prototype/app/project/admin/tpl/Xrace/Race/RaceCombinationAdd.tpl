...
<form action="{tpl:$this.sign/}&ac=race.combination.insert" name="race_combination_add_form" id="race_combination_add_form" method="post">
<input type="hidden" name="RaceStageId" id="RaceStageId" value="{tpl:$RaceStageInfo.RaceStageId/}" />
<table width="99%" align="center" class="table table-bordered table-striped">
  <tr class="hover"><th align="center" class="rowtip">组合名称</th><th align="center" class="rowtip"  colspan="2"><input name="RaceCombinationName" type="text" class="span2" id="RaceCombinationName" size="50" /></th></tr>
  <tr class="hover"><th align="center" class="rowtip">人数/价格对应<p>(人数;单价|人数:单价)</th><th align="center" class="rowtip"  colspan="2"><input name="PriceList" type="text" class="span2" id="PriceList" size="50" /></th></tr>
  ...
  <tr>
    ...
    <th align="center" class="rowtip"><input type="checkbox" name="RaceList[{tpl:$RaceInfo.RaceId/}]" id="RaceList[{tpl:$RaceInfo.RaceId/}]" value="1"></th>
  </tr>
  {/tpl:loop}
  {tpl:else}
  <tr>
  ...
  <tr>
    ...
    <th align="center" class="rowtip"><input type="text" class="span1" name="ProductList[{tpl:$ProductId/}][ProductCount]" id="ProductList[{tpl:$ProductId/}][ProductCount]" value="0"></th>
    </tr>
    {/tpl:if}
  </tr>
  {/tpl:loop}
  ...
  <tr class="noborder"><td></td>
    <td colspan="2"><button type="submit" id="race_combination_add_submit" >提交</button></td>
</table>
</form>
{tpl:tpl contentFooter/}
<script type="text/javascript">
  $('#race_combination_add_submit').click(function(){
    var options = {
      dataType:'json',
    ...
    $('#race_combination_add_form').ajaxForm(options);
  });
</script>