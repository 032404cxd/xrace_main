...
{tpl:loop $RaceCatalogList $RaceCatalogInfo}
  <tr class="hover">
    ...
    <td align="center">{tpl:$RaceCatalogInfo.RankingListUrl/} |  <a href="javascript:;" onclick="RaceCatalogModify('{tpl:$RaceCatalogInfo.RaceCatalogId/}');">修改</a> | <a  href="javascript:;" onclick="RaceCatalogDelete('{tpl:$RaceCatalogInfo.RaceCatalogId/}','{tpl:$RaceCatalogInfo.RaceCatalogName/}')">删除</a> |  <a href="javascript:;" onclick="RaceCatalogDisclaimerModify('{tpl:$RaceCatalogInfo.RaceCatalogId/}');">免责声明</a></td>
  </tr>
{/tpl:loop}
</table>
</fieldset>
