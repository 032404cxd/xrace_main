...
<table width="99%" align="center" class="table table-bordered table-striped">
  ...
  <tr><th colspan = 10>
      <table width="99%" align="center"  class="table table-bordered table-striped">
        ...
        <tr>
          <td>┠&nbsp;&nbsp;{tpl:$TimingInfo.TName/}</td><td>计时芯片序列号：{tpl:$TimingInfo.ChipId/}</td><td>距离下一计时点：{tpl:$TimingInfo.ToNext/}米</td><td>经过: {tpl:$TimingInfo.Round/} 次</td><td>海拔上升:{tpl:$TimingInfo.AltAsc/}米</td><td>海拔下降:{tpl:$TimingInfo.AltDec/}米</td><td>等待时间:{tpl:$TimingInfo.TolaranceTime/}秒</td>
