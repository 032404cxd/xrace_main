...
function LicenseDelete(g_id, l_id){
  deleteAppBox = divBox.confirmBox({content:'是否删除?',ok:function(){location.href = '{tpl:$this.sign/}&ac=group.license.delete&RaceGroupId=' + g_id + '&LicenseId=' + l_id;}});
}
