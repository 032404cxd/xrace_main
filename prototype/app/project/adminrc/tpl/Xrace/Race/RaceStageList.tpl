...
<table width="99%" align="center" class="table table-bordered table-striped">
  ...
  <tr>
    ...
    <th align="center" class="rowtip" ><a href="{tpl:$this.sign/}&ac=race.stage.user.check.in.status&RaceStageId={tpl:$RaceStageInfo.RaceStageId/}">签到</a> | <a href="{tpl:$this.sign/}&ac=chip.return.status&RaceStageId={tpl:$RaceStageInfo.RaceStageId/}">芯片归还</a> | <a  href="javascript:;" onclick="RaceStageDelete('{tpl:$RaceStageInfo.RaceStageId/}','{tpl:$RaceStageInfo.RaceStageName/}');">删除</a> |  <a href="javascript:;" onclick="RaceStageModify('{tpl:$RaceStageInfo.RaceStageId/}');">修改</a> | <a href="javascript:;" onclick="ProductModify('{tpl:$RaceStageInfo.RaceStageId/}');">产品</a> | <a href="{tpl:$this.sign/}&ac=race.combination.list&RaceStageId={tpl:$RaceStageInfo.RaceStageId/}">套餐组合</a> | <a href="{tpl:$this.sign/}&ac=aid.station.list&RaceStageId={tpl:$RaceStageInfo.RaceStageId/}">补给点</a>| <a href="javascript:;" onclick="RaceStageResultQR('{tpl:$RaceStageInfo.RaceStageId/}');">成绩查询</a> | <a href="{tpl:$this.sign/}&ac=aid.code.list&RaceStageId={tpl:$RaceStageInfo.RaceStageId/}">补给代码</a></th></tr>
