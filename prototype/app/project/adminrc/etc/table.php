...
#搜索关键字
$table['config_search_keyword']['db'] = 'rc_config';
$table['config_search_keyword']['num'] = 1;


#积分类目
$table['config_credit']['db'] = 'rc_config';
$table['config_credit']['num'] = 1;

#系统更新记录
$table['UpdateLog']['db'] = 'rc_config';
...
#计时点
$table['config_race']['db'] = 'rc_config';
$table['config_race']['num'] = 1;

#计时点
$table['config_timing_point']['db'] = 'rc_config';
...
#赛事
$table['config_race_catalog']['db'] = 'rc_config';
$table['config_race_catalog']['num'] = 1;

#比赛类型
$table['config_race_type']['db'] = 'rc_config';
$table['config_race_type']['num'] = 1;

#商品类型
$table['config_product_type']['db'] = 'rc_config';
$table['config_product_type']['num'] = 1;

#商品
$table['config_product']['db'] = 'rc_config';
$table['config_product']['num'] = 1;

#商品
$table['config_product_sku']['db'] = 'rc_config';
$table['config_product_sku']['num'] = 1;

#赛事报名套餐配置
$table['config_race_combination']['db'] = 'rc_config';
$table['config_race_combination']['num'] = 1;

#赛事分站
$table['config_race_stage']['db'] = 'rc_config';
$table['config_race_stage']['num'] = 1;

#赛事分组
$table['config_race_group']['db'] = 'rc_config';
...
#管理员组
$table['config_group']['db'] = 'rc_config';
$table['config_group']['num'] = 1;

#菜单
$table['config_menu']['db'] = 'rc_config';
$table['config_menu']['num'] = 1;

#菜单权限
$table['config_menu_purview']['db'] = 'rc_config';
$table['config_menu_purview']['num'] = 1;

#菜单权限
$table['config_menu_permission']['db'] = 'rc_config';
$table['config_menu_permission']['num'] = 1;

#数据权限
$table['config_data_permission']['db'] = 'rc_config';
$table['config_data_permission']['num'] = 1;

//操作日志
$table['config_logs_manager']['db'] = 'rc_config';
$table['config_logs_manager']['num'] = 16;

//APP版本
$table['config_app_version']['db'] = 'rc_config';
$table['config_app_version']['num'] = 1;

//APP系统
$table['config_app_os']['db'] = 'rc_config';
$table['config_app_os']['num'] = 1;

//APP类型
$table['config_app_type']['db'] = 'rc_config';
...
#动作
$table['config_action']['db'] = 'rc_config';
...
#补给点
$table['config_aid_station']['db'] = 'rc_config';
$table['config_aid_station']['num'] = 1;

#补给代码
$table['config_aid_code']['db'] = 'rc_config';
$table['config_aid_code']['num'] = 1;

#补给代码分类
$table['config_aid_code_type']['db'] = 'rc_config';
